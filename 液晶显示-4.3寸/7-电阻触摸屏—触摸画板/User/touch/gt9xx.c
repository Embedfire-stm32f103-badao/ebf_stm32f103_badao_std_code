...
const uint8_t CTP_CFG_GT917S[] =  {
    0x82,0xE0,0x01,0x20,0x03,0x05,0x0D,0x00,0x00,0x40,
    0x00,0x0F,0x78,0x64,0x53,0x11,0x01,0x00,0x00,0x00,
    0x14,0x17,0x19,0x1D,0x0F,0x04,0x00,0x00,0x00,0x00,
    0x00,0x00,0x04,0x51,0x14,0x00,0x00,0x00,0x00,0x00,
    0x32,0x00,0x00,0x50,0x54,0x28,0x8A,0x20,0x11,0x37,
    0x39,0xA2,0x07,0x38,0x6D,0x62,0x93,0x02,0x24,0x00,
    0x00,0x28,0x50,0xC0,0x02,0x02,0x00,0x00,0x53,0xB1,
    0x2E,0x9E,0x35,0x8D,0x3B,0x80,0x42,0x76,0x49,0x6D,
    ...
    0xFF,0xFF,0x12,0x13,0x14,0x15,0x17,0x18,0x19,0x1A,
    0x1B,0x1C,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
    0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x05,0x00,0x00,0x0F,
    0x00,0x00,0x00,0x80,0x46,0x08,0x96,0x50,0x32,0x0A,
    0x0A,0x64,0x32,0x00,0x00,0x00,0x00,0x00,0x00,0x70,
    0x22,0x03,0x0C,0x08,0x23,0x00,0x14,0x23,0x00,0x28,
    0x46,0x30,0x3C,0xD0,0x07,0x50,0xBE,0x0C,0x01
};
...
static void Goodix_TS_Work_Func(void)
{
    ...
    if (touch_num)
    {
        for (i = 0; i < touch_num; i++)						//一个点一个点处理
        {
            ...
            {
                GTP_Touch_Down( id, input_x, 480-input_y, input_w);//数据处理其中 480-input_y 是为了换一下y的方向
            }
        }
    }
