...
static uint16_t CurrentBackColor   = RED;//背景色

static __inline void                 NT35510_Write_Cmd           ( uint16_t usCmd );
static __inline void                 NT35510_Write_Data          ( uint16_t usData );
static __inline uint16_t             NT35510_Read_Data           ( void );
